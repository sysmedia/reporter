...
public class NewApp {
    ...
    public static void generateReport(ArrayList<String> list4){
        ...
        list1.addAll(list3);
        ArrayList<String> list5 = new ArrayList<String>(Arrays.asList(
                "1590","1295","1640"
        ));
        list1.removeAll(list5);
