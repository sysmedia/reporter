...
public class UpdateYearMonthForOneShop {
    public static void  main(String[] args) {
       ...
       for(String table : tableList) {
           sql = "update " + table + " set year = " + new_year1 + " , month = " + new_month1 + " where shop = " +
                   shopId + " and year = " + old_year1 + " and month = " + old_month1;
           System.out.println(sql);
           conn.update(sql);

           sql = "update " + table + " set year = " + new_year2 + " , month = " + new_month2 + " where shop = " +
                   shopId + " and year = " + old_year2 + " and month = " + old_month2;
           System.out.println(sql);
           conn.update(sql);
       }
