...
public class NewApp {
    public static void main(String[] args) {
      ...
      // sql = " select id from t_new_shop where city = '北京' and flag = 0 and sm = '物美'  and type = '大卖场'";
        ...
        for(int i = 0 ; i < list2.size(); i++) {
            ...
            try {
                ...
                wb.write(out);
                out.close();
                sql = "update t_new_shop set flag = 1 , shop1 = " + origShopId + ", year1 = 2017, month1 = '07', year2 = 2017, month2 = '08', "
